      ...
      <section>
        <div class="flex">
          <div class="max-w-xs">
            ...
            >
              <span
                v-if="filteredNames[0]"
                @click="setTippedTicker"
                class="inline-flex items-center px-2 m-1 rounded-md text-xs font-medium bg-gray-300 text-gray-800 cursor-pointer"
              >
                {{ filteredNames[0].Symbol }}
              </span>
              <span
                v-if="filteredNames[1]"
                @click="setTippedTicker"
                class="inline-flex items-center px-2 m-1 rounded-md text-xs font-medium bg-gray-300 text-gray-800 cursor-pointer"
              >
                {{ filteredNames[1].Symbol }}
              </span>
              <span
                v-if="filteredNames[2]"
                @click="setTippedTicker"
                class="inline-flex items-center px-2 m-1 rounded-md text-xs font-medium bg-gray-300 text-gray-800 cursor-pointer"
              >
                {{ filteredNames[2].Symbol }}
              </span>
              <span
                v-if="filteredNames[3]"
                @click="setTippedTicker"
                class="inline-flex items-center px-2 m-1 rounded-md text-xs font-medium bg-gray-300 text-gray-800 cursor-pointer"
              >
                {{ filteredNames[3].Symbol }}
              </span>
            </div>
...
export default {
  ...
  methods: {
    ...
    handleDelete(tickerToRemove) {
      ...
      this.tickerNames = this.tickerNames.filter(
        (item) => item != tickerToRemove.name
      );
  ...
  computed: {
    ...
    filteredNames() {
      return this.existingNames.filter((name) =>
